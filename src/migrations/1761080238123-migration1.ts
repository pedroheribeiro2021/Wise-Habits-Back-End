...
export class Migration11761080238123 implements MigrationInterface {
    name = 'Migration11761080238123'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "habit_status" ("id" SERIAL NOT NULL, "statuses" jsonb NOT NULL, "habitId" uuid, CONSTRAINT "PK_86e4a100b2cd7b6c4cfc1a99ebe" PRIMARY KEY ("id"))`);
        await queryRunner.query(`ALTER TABLE "habits" ADD CONSTRAINT "FK_356d1f144ceadad6942fa17af64" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "habit_status" ADD CONSTRAINT "FK_3e1301dc0cfe7322a7a5a381103" FOREIGN KEY ("habitId") REFERENCES "habits"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }
